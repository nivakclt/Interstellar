  ...
  return (
    <div className="hud-layer">
      ...
      <div className="hud-left-data">
        ...
        <div className="hud-data-block">
          <span>VELOCITY</span>
          <strong>28,491</strong>
          <small>KM / S</small>
        </div>

        <div className="hud-data-block">
          <span>GRAVITY</span>
          <strong>09.481</strong>
          <small>G-FORCE</small>
        </div>
      </div>
      ...
      <div className="hud-target">
        ...
        <div className="target-label">GARGANTUA</div>
      </div>
      ...
      <div className="hud-right-data">
        ...
        <div className="hud-status-row">
          ...
          <strong className="hud-green">NOMINAL</strong>
        </div>

        <div className="hud-status-row">
          <span>HULL</span>
          <strong className="hud-green">99.8%</strong>
        </div>
        ...
        <div className="hud-status-row">
          <span>COMMS</span>
          <strong className="hud-green">ONLINE</strong>
        </div>
      </div>
